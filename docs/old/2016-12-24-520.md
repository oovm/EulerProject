...
<span style="color: #ff0000;"> 竟然.....没做出来,放弃......实在不会剪枝....
...
<span style="color: #ff0000;">跳过未做,未计时.

<span style="color: #ff0000;">ShowHardQ函数返回给定牌局的胜负向量,输入长度除以5返回对应的排序向量.
...
<center>
  <span style="color: #ff0000;"><strong>37</strong> 36 35 34 33 32 <span style="color: #ff0000;"><strong>31</strong> 38 <span style="color: #ff0000;"><strong>17</strong> 16 15 14 <span style="color: #ff0000;"><strong>13</strong> 30 39 18  <span style="color: #ff0000;"><strong>5</strong>  4  <span style="color: #ff0000;"><strong>3</strong> 12 29 40 19  6  <span style="color: #000000;">1  2 11 28 41 20 <span style="color: #ff0000;"> <strong>7</strong>  8  <span style="color: #000000;">9 10 27 42<span style="color: #000000;"> 21 22 23 24 <span style="color: #000000;">25 26 <span style="color: #ff0000;"><strong>43</strong> 44 45 46 47 48 <span style="color: #000000;">49
...
你的破解任务要简单得多, 因为密钥只由三个小写字母构成.文本文档<a href="https://projecteuler.net/project/resources/p059_cipher.txt" target="_blank" rel="external">cipher.txt</a>(右击并选择"目标另存为……")中包含了加密后的ASCII码, 并且已知明文包含的一定是常见的英文单词, 解密这条消息并求出原文的ASCII码之和.
