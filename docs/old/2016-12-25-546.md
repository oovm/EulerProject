...
<span style="color: #0000ff;">化简下,于是就从几何问题转化为了代数问题,求这个的整数解.这时候开始穷举也行,不过还能化简公式.</span>
...
<span style="color: #0000ff;">没括号的64种情况下是这样的,好吧我就是想秀一下我珍藏多年的强力函数.....</span>
...
<span style="color: #0000ff;">(14,8)对应的是(5,5,6)差了一项,要位移一格...</span>
