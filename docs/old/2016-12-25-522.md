...
<span style="color: #ff0000;">说个关于$\LaTeX$语法的重要提示,书写连分数表达式时,要使用\cfrac代替\frac或者\over.不然你的公式就会挤一起特难看...
...
3^2 – 2×2^2 = 1
2^2 – 3×1^2 = 1
9^2 – 5×<span style="color: #ff0000;">4^2 = 1
5^2 – 6×2^2 = 1
8^2 – 7×3^2 = 1
...
<span style="color: #ff0000;">本题看了一下,未做未计时,我会告诉你我是手填的吗...
