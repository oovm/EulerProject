...
<span style="color: #ff0000;">啥,你说循环?我们是高逼格的函数式编程,用了循环还怎么高冷的装逼...

<span style="color: #ff0000;">除非要用到编译否则我就不写循环.NestWhile写起来不比循环爽吗...
...
<span style="color: #ff0000;">主要是循环没有返回值很蛋疼好不好(其实可以有),而且还要初始化(写法对就不用)....
